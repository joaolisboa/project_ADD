...
public class SettingsPresenterOld implements SettingsContract.Presenter {
    ...
    public SettingsPresenterOld(SettingsContract.View settingsView, DrawerView drawerView,
